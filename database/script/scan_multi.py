...
# 내용을 추가할 수 있음
cmc = ['python', scan_single_path, '--db_cfg', f'{db_cfg}', '--sto_cfg', f'{sto_cfg}', '--tbl_cfg', f'{tbl_cfgs[0]}', '--create', 'True']
...
for tbl_cfg in tbl_cfgs:
    ...
    cmd = ['python', scan_single_path, '--db_cfg', f'{db_cfg}', '--sto_cfg', f'{sto_cfg}', '--tbl_cfg', f'{tbl_cfg}']
