...
kasi_boh_mag_list = ['kasi_boh_mag_mi_ms_txt', 'kasi_boh_mag_min', 'kasi_boh_mag_min_average', 
                     'kasi_boh_mag_pi2_list', 'kasi_boh_mag_pi2_power', 'kasi_boh_mag_mi_spectrum_x',
                     'kasi_boh_mag_mi_spectrum_y', 'kasi_boh_mag_mi_spectrum_z', 'kasi_boh_mag_sec5',
                     'kasi_boh_mag_kindex']
...
table_list = [noaa_ace_list, kasi_boh_mag_list, kasi_hq_ecallisto_list, kopri_jbs_scint_list, noaa_dscovr_list, wdc_dst_list]
table_name_list = ['noaa_ace', 'kasi_boh_mag', 'kasi_hq_ecallisto', 'kopri_jbs_scint', 'noaa_dscovr', 'wdc_dst']
